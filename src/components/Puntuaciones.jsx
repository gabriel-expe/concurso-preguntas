...
export default function Puntuaciones() {
  ...
  return (
    ...
    <div className="list-group w-75 mt-5">
      ...
      {
        listaUsuarios.map((u)=>(
        <li key={u.id} className="list-group-item list-group-item-action flex-column align-items-start bg-dark text-light">
        <div className="d-flex">
          <h5 className="mb-1 container-fluid mt-2">Nickname: {u.nickname} </h5>
